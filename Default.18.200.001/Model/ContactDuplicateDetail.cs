...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactDuplicateDetail : Entity,  IEquatable<ContactDuplicateDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactDuplicateDetail" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactDuplicateDetail {\n");
        ...
        {
            return this.Equals(input as ContactDuplicateDetail);
        }

        /// <summary>
        /// Returns true if ContactDuplicateDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactDuplicateDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactDuplicateDetail input)
        {
            if (input == null)
                return false;
