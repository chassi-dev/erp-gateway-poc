...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InventoryReceiptDetailAllocation : Entity,  IEquatable<InventoryReceiptDetailAllocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryReceiptDetailAllocation" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InventoryReceiptDetailAllocation {\n");
        ...
        {
            return this.Equals(input as InventoryReceiptDetailAllocation);
        }

        /// <summary>
        /// Returns true if InventoryReceiptDetailAllocation instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryReceiptDetailAllocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryReceiptDetailAllocation input)
        {
            if (input == null)
                return false;
