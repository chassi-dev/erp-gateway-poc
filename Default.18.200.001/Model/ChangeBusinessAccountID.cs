...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChangeBusinessAccountID :  IEquatable<ChangeBusinessAccountID>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeBusinessAccountID" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChangeBusinessAccountID() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeBusinessAccountID" /> class.
        /// </summary>
        ...
        public ChangeBusinessAccountIDParameters Parameters { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangeBusinessAccountID {\n");
        ...
        {
            return this.Equals(input as ChangeBusinessAccountID);
        }

        /// <summary>
        /// Returns true if ChangeBusinessAccountID instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeBusinessAccountID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeBusinessAccountID input)
        {
            if (input == null)
                return false;
