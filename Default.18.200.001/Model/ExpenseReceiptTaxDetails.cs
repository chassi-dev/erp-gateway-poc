...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpenseReceiptTaxDetails : Entity,  IEquatable<ExpenseReceiptTaxDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseReceiptTaxDetails" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExpenseReceiptTaxDetails {\n");
        ...
        {
            return this.Equals(input as ExpenseReceiptTaxDetails);
        }

        /// <summary>
        /// Returns true if ExpenseReceiptTaxDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenseReceiptTaxDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenseReceiptTaxDetails input)
        {
            if (input == null)
                return false;
