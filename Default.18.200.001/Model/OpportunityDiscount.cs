...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpportunityDiscount : Entity,  IEquatable<OpportunityDiscount>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpportunityDiscount {\n");
        ...
        {
            return this.Equals(input as OpportunityDiscount);
        }

        /// <summary>
        /// Returns true if OpportunityDiscount instances are equal
        /// </summary>
        /// <param name="input">Instance of OpportunityDiscount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpportunityDiscount input)
        {
            if (input == null)
                return false;
