...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    public partial class BusinessAccountShippingContact : Entity,  IEquatable<BusinessAccountShippingContact>, IValidatableObject
    {
        ...
        public BusinessAccountShippingContact(StringValue attention = default(StringValue), StringValue email = default(StringValue), StringValue fax = default(StringValue), StringValue jobTitle = default(StringValue), StringValue phone1 = default(StringValue), StringValue phone2 = default(StringValue), BooleanValue sameasMain = default(BooleanValue), Guid? id = default(Guid?), long? rowNumber = default(long?), string note = default(string), Dictionary<string, Dictionary<string, CustomField>> custom = default(Dictionary<string, Dictionary<string, CustomField>>), List<FileLink> files = default(List<FileLink>)) : base(id, rowNumber, note, custom, files)
        {
