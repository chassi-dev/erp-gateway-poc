...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceDiscountDetails : Entity,  IEquatable<SalesInvoiceDiscountDetails>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesInvoiceDiscountDetails {\n");
        ...
        {
            return this.Equals(input as SalesInvoiceDiscountDetails);
        }

        /// <summary>
        /// Returns true if SalesInvoiceDiscountDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceDiscountDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceDiscountDetails input)
        {
            if (input == null)
                return false;
