...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CaseDetail : Entity,  IEquatable<CaseDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseDetail" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CaseDetail);
        }

        /// <summary>
        /// Returns true if CaseDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of CaseDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaseDetail input)
        {
            if (input == null)
                return false;
