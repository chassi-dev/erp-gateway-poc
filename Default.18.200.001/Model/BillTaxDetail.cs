...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    public partial class BillTaxDetail : Entity,  IEquatable<BillTaxDetail>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as BillTaxDetail);
        }

        /// <summary>
        /// Returns true if BillTaxDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of BillTaxDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillTaxDetail input)
        {
            if (input == null)
                return false;
