...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DiscountCustomerPriceClassesDetail : Entity,  IEquatable<DiscountCustomerPriceClassesDetail>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DiscountCustomerPriceClassesDetail {\n");
        ...
        {
            return this.Equals(input as DiscountCustomerPriceClassesDetail);
        }

        /// <summary>
        /// Returns true if DiscountCustomerPriceClassesDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DiscountCustomerPriceClassesDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiscountCustomerPriceClassesDetail input)
        {
            if (input == null)
                return false;
