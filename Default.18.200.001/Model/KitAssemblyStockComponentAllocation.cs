...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KitAssemblyStockComponentAllocation : Entity,  IEquatable<KitAssemblyStockComponentAllocation>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KitAssemblyStockComponentAllocation {\n");
        ...
        {
            return this.Equals(input as KitAssemblyStockComponentAllocation);
        }

        /// <summary>
        /// Returns true if KitAssemblyStockComponentAllocation instances are equal
        /// </summary>
        /// <param name="input">Instance of KitAssemblyStockComponentAllocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KitAssemblyStockComponentAllocation input)
        {
            if (input == null)
                return false;
