...
namespace Acumatica.DefaultEndpoint.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountBySubaccountRow : Entity,  IEquatable<AccountBySubaccountRow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountBySubaccountRow" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountBySubaccountRow {\n");
        ...
        {
            return this.Equals(input as AccountBySubaccountRow);
        }

        /// <summary>
        /// Returns true if AccountBySubaccountRow instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountBySubaccountRow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountBySubaccountRow input)
        {
            if (input == null)
                return false;
